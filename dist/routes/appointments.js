...
router.post('/', async (req, res) => {
    const { type, startTime, endTime, clientId, contactName, contactEmail, contactPhone, address, userId, slotId, notes, adminNotes, } = req.body;
...
router.put('/:id', async (req, res) => {
    const { type, status, startTime, endTime, clientId, contactName, contactEmail, contactPhone, address, userId, notes, adminNotes, } = req.body;
    try {
...
router.delete('/:id', async (req, res) => {
    try {
        const appt = await database_1.default.appointment.findUnique({ where: { id: req.params.id } });
        await database_1.default.appointment.delete({ where: { id: req.params.id } });
